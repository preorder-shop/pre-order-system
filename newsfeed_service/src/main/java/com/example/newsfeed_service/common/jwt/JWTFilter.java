...
import static com.example.newsfeed_service.common.response.BaseResponseStatus.TOKEN_INVALID;

import com.example.newsfeed_service.client.UserServiceClient;
...
public class JWTFilter extends OncePerRequestFilter { // JWT 검증 필터 -> 헤더로 들어온 jwt 토큰을 검증
    ...
    private static final String[] whiteList = {"/feeds/internal/*","/feeds/test"};
